...
**Current native:** `0.0.48-slice2au` — TEX_ENVIRONMENT×0 MULTIPLY → world Strength (after 3-deep Math). Addon still `0.3.3`.
...
`-DQT_WITH_CYCLES=ON`. Native `0.0.48-slice2au` (TEX_ENVIRONMENT×0 Strength).
