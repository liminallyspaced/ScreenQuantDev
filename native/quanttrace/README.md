...
**Current native:** `0.0.57-slice2bd` — RGB Curves → Principled Base Color. Addon still `0.3.3`.
...
`-DQT_WITH_CYCLES=ON`. Native `0.0.57-slice2bd` (RGB Curves → Principled Base Color).
