...
**Current native:** `0.0.51-slice2ax` — Gamma/HueSat → Principled Base Color (after pack caps). Addon still `0.3.3`.
...
`-DQT_WITH_CYCLES=ON`. Native `0.0.51-slice2ax` (mesh/light pack caps).
