...
**Current native:** `0.0.47-slice2at` — 3-deep Math nest → world Strength (after RGB Curves). Addon still `0.3.3`.
...
`-DQT_WITH_CYCLES=ON`. Native `0.0.47-slice2at` (3-deep Math Strength).
