...
**Current native:** `0.0.56-slice2bc` — Noise → Bump.Height → Principled.Normal. Addon still `0.3.3`.
...
`-DQT_WITH_CYCLES=ON`. Native `0.0.56-slice2bc` (Noise → Bump.Height → Principled.Normal).
