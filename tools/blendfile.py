# Vendored from Blender (DNA .blend reader, no bpy).
# Source: https://raw.githubusercontent.com/blender/blender-dev-tools/main/modules/blendfile.py
# (scripts/modules/blendfile.py 404 on blender/blender main; this is the intern equivalent.)
#
