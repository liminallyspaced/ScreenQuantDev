# QuantTrace Slice 2k: locked cube + TEX_COORD Generated [→ Mapping] → TEX_IMAGE.
...
def build_generated_scene(
    image_path="/tmp/qt_checker_gen.png",
    *,
    use_mapping=False,
    scale=(2.0, 2.0, 2.0),
    ...
    """TEX_COORD Generated [→ Mapping VECTOR] → TEX_IMAGE Vector → Base Color."""
...
def main():
    ...
    p.add_argument("--out", default="/tmp/quanttrace_gen_stock.exr")
    ...
    scene, cube_obj, lamp, cam, img = build_generated_scene(
    ...
    print(
        "QUANTTRACE_GEN", cube_obj.name, "mode", args.mode,
    ...
    if args.render:
        ...
        print("QUANTTRACE_GEN wrote", args.out)
    return 0
