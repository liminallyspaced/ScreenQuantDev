"""Slice 2bp census: nested Mix Shader hop in loft Realistic_Glass_01.
...
Cite Cycles shader_nodes.h:
  ...
  AddClosureNode: Closure1/Closure2
  LightPathNode: Is * Ray outs
  MathNode: Value1/Value2, math_type, use_clamp

Do NOT invent the graph — print what loft actually has.
"""
