...
def build_mapping_scene(
    ...
    *,
    ...
    coord: "UV" (2h), "Generated" (2k), "Object" (2l), "Camera" (2m),
    "Window"/"Reflection" (2n).
    """
...
def main():
    ...
    p.add_argument("--coord", choices=("UV", "Generated", "Object", "Camera", "Window", "Reflection"), default="UV")
