# QuantTrace Slice 2l: locked cube + TEX_COORD Object [→ Mapping] → TEX_IMAGE.
...
def build_object_scene(
    image_path="/tmp/qt_checker_obj.png",
    *,
    use_mapping=False,
    scale=(2.0, 2.0, 2.0),
...
def main():
    ...
    p.add_argument("--out", default="/tmp/quanttrace_obj_stock.exr")
    ...
    scene, cube_obj, lamp, cam, img = build_object_scene(
    ...
    print(
        "QUANTTRACE_OBJ", cube_obj.name, "mode", args.mode,
    ...
    if args.render:
        ...
        print("QUANTTRACE_OBJ wrote", args.out)
    return 0
