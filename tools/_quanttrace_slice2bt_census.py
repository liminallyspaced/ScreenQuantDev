"""Slice 2bt census: Mix.004 leftover in loft Realistic_Glass_01 after 2bp.
...
print("\n=== Slice 2bt dry pack probe (first PACK_FAIL) ===")
try:
    import os, sys
...
print("\n=== Slice 2bt Mix.002 / Mix.003 / Glossy / SSS / Translucent dump ===")
