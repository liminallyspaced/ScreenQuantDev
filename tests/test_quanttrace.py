...
def main():
    ...
    check("0.0.71-slice2br" in hello_c, "hello.c version string 0.0.71-slice2br")
    ...
    hello = _read("native/quanttrace/src/hello.c")
    check("0.0.71-slice2br" in hello, "hello version is 0.0.71-slice2br")
    ...
    hello = _read("native/quanttrace/src/hello.c")
    check("0.0.71-slice2br" in hello, "native version 0.0.71-slice2br")
    ...
    section("Slice 2br nested2 Mix Fac<-ColorRamp")
    hdr = _read("native/quanttrace/src/quanttrace.h")
